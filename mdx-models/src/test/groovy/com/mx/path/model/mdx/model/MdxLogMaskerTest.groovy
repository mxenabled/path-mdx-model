...
class MdxLogMaskerTest extends Specification {
  def cleanup() {
    MdxLogMasker.disabled = false
  }

  @Unroll
  def "maskHeaderValue() does not mask #header when masker disable"() {
    when:
    MdxLogMasker.disabled = true
    MdxLogMasker.registerMaskerPatterns()
    ...
    "mx-refresh-token" || "something_sensitive"
  }
  ...
  @Unroll
  def "maskPayload() does not mask #payload when masker disabled"() {
    when:
    MdxLogMasker.disabled = true
    MdxLogMasker.registerMaskerPatterns()
    ...
    "\"id\":\"ACCOUNT-123\""                     || "\"id\":\"ACCOUNT-123\""
    "\"name\":\"Checking Account\""              || "\"name\":\"Checking Account\""
    "\"nickname\":\"My Checking\""               || "\"nickname\":\"My Checking\""
    "\"routing_number\":\"121122676\""           || "\"routing_number\":\"121122676\""
    "\"routing_transit_number\":\"0260-0959-3\"" || "\"routing_transit_number\":\"0260-0959-3\""
  }
