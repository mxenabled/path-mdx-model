...
public class AccountBehavior {
  ...
  private Map<ServiceIdentifier, String> mappedAccountIds = new HashMap<>();
   ...
   */
  public final Map<ServiceIdentifier, String> getMappedAccountIds() {
   ...
   */
  public final void setMappedAccountIds(Map<ServiceIdentifier, String> mappedAccountIds) {
