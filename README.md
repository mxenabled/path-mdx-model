...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:1.7.1")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:1.7.1"
  implementation "com.mx.path-mdx-model:mdx-gateways:1.7.1"
  implementation "com.mx.path-mdx-model:realtime:1.7.1"
}
```
<!-- x-release-please-end -->
