...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:20.2.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:20.2.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:20.2.0"
  implementation "com.mx.path-mdx-model:realtime:20.2.0"
}
```
<!-- x-release-please-end -->
