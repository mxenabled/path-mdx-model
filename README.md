...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:16.6.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:16.6.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:16.6.0"
  implementation "com.mx.path-mdx-model:realtime:16.6.0"
}
```
<!-- x-release-please-end -->
