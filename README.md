...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:21.2.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:21.2.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:21.2.0"
  implementation "com.mx.path-mdx-model:realtime:21.2.0"
}
```
<!-- x-release-please-end -->
