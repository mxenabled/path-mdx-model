...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:8.0.1")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:8.0.1"
  implementation "com.mx.path-mdx-model:mdx-gateways:8.0.1"
  implementation "com.mx.path-mdx-model:realtime:8.0.1"
}
```
<!-- x-release-please-end -->
