...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:19.0.2")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:19.0.2"
  implementation "com.mx.path-mdx-model:mdx-gateways:19.0.2"
  implementation "com.mx.path-mdx-model:realtime:19.0.2"
}
```
<!-- x-release-please-end -->
