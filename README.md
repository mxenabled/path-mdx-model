...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:17.0.4")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:17.0.4"
  implementation "com.mx.path-mdx-model:mdx-gateways:17.0.4"
  implementation "com.mx.path-mdx-model:realtime:17.0.4"
}
```
<!-- x-release-please-end -->
