...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:11.3.2")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:11.3.2"
  implementation "com.mx.path-mdx-model:mdx-gateways:11.3.2"
  implementation "com.mx.path-mdx-model:realtime:11.3.2"
}
```
<!-- x-release-please-end -->
