...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:21.3.1")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:21.3.1"
  implementation "com.mx.path-mdx-model:mdx-gateways:21.3.1"
  implementation "com.mx.path-mdx-model:realtime:21.3.1"
}
```
<!-- x-release-please-end -->
