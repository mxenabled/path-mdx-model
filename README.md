[![Maven Central](https://maven-badges.herokuapp.com/maven-central/com.mx.path-mdx-model/platform/badge.svg)](https://search.maven.org/search?q=com.mx.path-mdx-model)
...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:1.7.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:1.7.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:1.7.0"
  implementation "com.mx.path-mdx-model:realtime:1.7.0"
}
```
<!-- x-release-please-end -->
