...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:16.9.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:16.9.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:16.9.0"
  implementation "com.mx.path-mdx-model:realtime:16.9.0"
}
```
<!-- x-release-please-end -->
