...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:15.0.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:15.0.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:15.0.0"
  implementation "com.mx.path-mdx-model:realtime:15.0.0"
}
```
<!-- x-release-please-end -->
