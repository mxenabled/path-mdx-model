...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:16.9.1")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:16.9.1"
  implementation "com.mx.path-mdx-model:mdx-gateways:16.9.1"
  implementation "com.mx.path-mdx-model:realtime:16.9.1"
}
```
<!-- x-release-please-end -->
