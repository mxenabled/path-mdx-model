...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:5.6.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:5.6.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:5.6.0"
  implementation "com.mx.path-mdx-model:realtime:5.6.0"
}
```
<!-- x-release-please-end -->
