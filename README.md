...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:1.6.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:1.6.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:1.6.0"
  implementation "com.mx.path-mdx-model:realtime:1.6.0"
}
```
<!-- x-release-please-end -->
