...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:16.7.2")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:16.7.2"
  implementation "com.mx.path-mdx-model:mdx-gateways:16.7.2"
  implementation "com.mx.path-mdx-model:realtime:16.7.2"
}
```
<!-- x-release-please-end -->
