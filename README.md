...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:11.0.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:11.0.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:11.0.0"
  implementation "com.mx.path-mdx-model:realtime:11.0.0"
}
```
<!-- x-release-please-end -->
