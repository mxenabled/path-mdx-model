...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:17.0.8")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:17.0.8"
  implementation "com.mx.path-mdx-model:mdx-gateways:17.0.8"
  implementation "com.mx.path-mdx-model:realtime:17.0.8"
}
```
<!-- x-release-please-end -->
