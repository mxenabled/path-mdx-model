...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:4.10.1")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:4.10.1"
  implementation "com.mx.path-mdx-model:mdx-gateways:4.10.1"
  implementation "com.mx.path-mdx-model:realtime:4.10.1"
}
```
<!-- x-release-please-end -->
