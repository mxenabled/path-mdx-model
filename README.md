...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:4.13.0")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:4.13.0"
  implementation "com.mx.path-mdx-model:mdx-gateways:4.13.0"
  implementation "com.mx.path-mdx-model:realtime:4.13.0"
}
```
<!-- x-release-please-end -->
