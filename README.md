...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:4.14.2")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:4.14.2"
  implementation "com.mx.path-mdx-model:mdx-gateways:4.14.2"
  implementation "com.mx.path-mdx-model:realtime:4.14.2"
}
```
<!-- x-release-please-end -->
