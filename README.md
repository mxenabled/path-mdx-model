...
```groovy
dependencies {
  api platform("com.mx.path-mdx-model:platform:23.0.2")
...
```groovy
dependencies {
  implementation "com.mx.path-mdx-model:mdx-models:23.0.2"
  implementation "com.mx.path-mdx-model:mdx-gateways:23.0.2"
  implementation "com.mx.path-mdx-model:realtime:23.0.2"
}
```
<!-- x-release-please-end -->
